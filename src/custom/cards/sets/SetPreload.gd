...
const CARD_SETS := [preload("res://src/custom/cards/sets/SetDefinition_MyCardGame.gd")]
...
const CARD_SCRIPTS := [preload("res://src/custom/cards/sets/SetScripts_MyCardGame.gd")]
